...
const AuthorUpdateFormPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setUploadProgress(language === 'tr' ? 'Güncelleme oluşturuluyor...' : 'Creating update...');
      ...
      if (selectedFile) {
        ...
        setUploadProgress(language === 'tr' ? 'Dosya yükleniyor...' : 'Uploading file...');
      ...
      setUploadProgress(language === 'tr' ? 'Makale güncelleniyor...' : 'Updating entry...');
      ...
      if (selectedFile) {
        setUploadProgress(language === 'tr' ? 'Makale dosyası güncelleniyor...' : 'Updating entry file...');
              ...
              >
                {isSubmitting ? (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    <span>{uploadProgress || (language === 'tr' ? 'Gönderiliyor...' : 'Submitting...')}</span>
                  </div>
