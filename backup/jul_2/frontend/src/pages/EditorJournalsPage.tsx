    ...
    if (authLoading || loading) {
        return (
            <div style={{
                ...
                }}>{language === 'tr' ? 'Dergiler Yükleniyor...' : 'Loading Journals...'}</p>
            </div>
        );
    }
            ...
            <div className="page-content-section" style={{
                ...
                {journalsWithEntries.length === 0 ? (
                    <div className="records-empty-state">
                        ...
                        <h3>{language === 'tr' ? 'Atanmış Dergi Bulunmamaktadır' : 'No Journals Assigned'}</h3>
                        <p>
                            {language === 'tr' 
                                ? 'Eğer bunun bir hata olduğunu düşünüyorsanız bir yönetici ile iletişime geçin.'
