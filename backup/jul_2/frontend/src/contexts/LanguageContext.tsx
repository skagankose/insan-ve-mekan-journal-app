...
type TranslationKeys = 
  ...
  | 'role_admin' | 'role_owner' | 'role_editor' | 'role_author' | 'role_referee' | 'role_user'
  ...
  | 'records' | 'editorJournals' | 'submitPaper' | 'publishedIssues' | 'searchPlaceholder' | 'viewJournal' | 'readMore'
  ...
  | 'referenceToken' | 'manageAuthors' | 'addAuthor' | 'changeJournal' | 'manageReferees' | 'noPublishedEntries'
  ...
  | 'noUpdates' | 'startConversation' | 'loadingEntryData'
  ...
  | 'linkCopied' | 'copyFailed' | 'pleaseWait' | 'loadingEntry'
  // Email Confirmation
...
| 'maxCharacters'
| 'fileTooLarge'
// File upload progress translations
| 'updatingEntryData' | 'uploadingDocxFile' | 'uploadingPdfFile';
...
const translations: Record<Language, TranslationDictionary> = {
  en: {
    ...
    'save': 'Save',
    'publicationDetails': 'Extra Information',
    ...
    'loadingEntryData': 'Loading entry data...',
    'loadingEntry': 'Loading...',
    'updatingEntryData': 'Updating Entry Data',
    'uploadingDocxFile': 'Uploading DOCX File',
  ...
  tr: {
    ...
    'save': 'Kaydet',
    'publicationDetails': 'Detay Bilgiler',
    ...
    'paymentInfoMessage': 'Yayım sürecine devam edebilmek için lütfen bu menüdeki talimatları takip ederek ödemeyi tamamlayınız',
    ...
    'privateNotes': 'Özel Notlar (Oluşturan Hakem ve Yazarlar Tarafından Görüntülenebilir)',
    ...
    'phoneValidationError': 'Telefon numarası 555 555 55 55 formatta olmalıdır',
    ...
    'paperNotFoundUpdateExplanation': 'Bu makalenin güncellemelerini yüklerken bir sorunla karşılaştık.',
      ...
      'noParticipants': 'Katılımcı Bulunamadı',
          'pleaseConfirmEmail': 'Giriş yapmak için lütfen e-posta adresinizi onaylayın. Spam klasörünüzü kontrol ediniz.',
    ...
    'loadingEntryData': 'Makale yükleniyor...',
    'loadingEntry': 'Yükleniyor...',
    'updatingEntryData': 'Güncelleniyor',
    'uploadingDocxFile': 'DOCX dosyası yükleniyor',
    'uploadingPdfFile': 'PDF dosyası yükleniyor'
  }
};
