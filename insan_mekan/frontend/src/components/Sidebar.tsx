...
import { MdEdit, MdArchive, MdDashboard, MdPerson } from 'react-icons/md';
        ...
        <ul className="sidebar-menu">
          ...
          {isAuthenticated && (
            <li className="sidebar-menu-item">
              <Link 
                to="/records" 
                className={`sidebar-link ${isActiveLink('/records') ? 'active' : ''}`}
              >
                <MdPerson className="sidebar-icon" />
                <div className="sidebar-link-content">
                  <span className="sidebar-link-title">{t('records') || 'Records'}</span>
                </div>
              </Link>
            </li>
          )}
