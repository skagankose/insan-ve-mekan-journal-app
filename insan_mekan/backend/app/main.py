...
origins = [
    ...
    "https://insanvemekan.com",  # Production domain
    "https://www.insanvemekan.com",  # Production domain with www
    "https://164.92.132.255:5173", # Allow requests from Vite dev server (legacy)
    "https://164.92.132.255:8000", # Allow requests from Vite dev server (legacy)
    "https://164.92.132.255", # Allow requests from Vite dev server (legacy)
