...
**TODO:** Choose a license that fits your needs (e.g., MIT for code, CC BY-NC for content).  
Add the text to `LICENSE` and reference it here.

---

### Maintainers

- **İNSAN VE MEKAN** editorial team — contact: **info@humanandspace.com** *(update as needed)*
